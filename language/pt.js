...
const translations = {
    ...
    with: 'Razão',
    afkmsg: 'Avisarei a quem mencionar você',
    afktag: 'O usuário está Offline',
    name: 'Nome',
  ...
  warnNan: 'O usuário não possui nenhuma advertencia',
  delwarn: 'Remover aviso',
  warns: 'Advertencias',
  warn: 'Advertencia',
  warnRec: 'Você recebeu uma advertencia de um administrador',
  ...
  wningUser: (war) => `Se você receber *${war}* advertencias, será automaticamente expulso do grupo`,
  warnMaxU: (war) => `O usuário excedeu as *${war}* advertencias e será expulso`,
